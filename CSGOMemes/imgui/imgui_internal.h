...
namespace ImGui
{
    ...
    IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, ImU32 col, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
