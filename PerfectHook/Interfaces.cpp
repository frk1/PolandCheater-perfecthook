...
void InitialiseInterfaces()
{
    ...
    g_Client         = (IBaseClientDLL*)ClientPointer("VClient018", nullptr);
	...
	g_EntityList     = (IClientEntityList*)ClientPointer("VClientEntityList003", nullptr);
    ...
    g_Trace          = (IEngineTrace*)EnginePointer("EngineTraceClient004", nullptr);
    ...
    g_Input          = *(CInput**)((*reinterpret_cast<DWORD**>(g_Client))[15] + 0x1);
